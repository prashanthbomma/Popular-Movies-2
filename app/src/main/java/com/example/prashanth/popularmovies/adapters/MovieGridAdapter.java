package com.example.prashanth.popularmovies.adapters;
...
import com.example.prashanth.popularmovies.R;
...
public class MovieGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(getContext()).load(image_url).placeholder(R.drawable.default_placeholder).into(viewHolder.imageView);
