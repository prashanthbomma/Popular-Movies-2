...
import com.example.prashanth.popularmovies.adapters.ReviewAdapter;
import com.example.prashanth.popularmovies.adapters.TrailerAdapter;
import com.example.prashanth.popularmovies.data.MovieContract;
import com.example.prashanth.popularmovies.model.Movie;
import com.example.prashanth.popularmovies.model.Review;
import com.example.prashanth.popularmovies.model.Trailer;
...
public class DetailActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMovie != null) {
            ...
            Glide.with(this).load(image_url).placeholder(R.drawable.default_placeholder).into(mImageView);
        ...
        protected List<Trailer> doInBackground(String... params) {
            ...
            try {
                ...
                Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                        .appendQueryParameter(API_KEY_PARAM,"YOUR_API_KEY_HERE") // <-------ENTER YOUR TMDB API KEY HERE
                        .build();
